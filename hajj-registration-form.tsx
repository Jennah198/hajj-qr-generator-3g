            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-green-100 border-yellow-400 focus:border-yellow-400 focus:ring-yellow-400/20 file:bg-hajj-gold file:text-hajj-black file:border-0 file:rounded-md file:px-3 file:py-1 file:mr-3"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange("travelAgencyName", e.target.value)}
          ...
          <Card className="border-2 border-yellow-400 shadow-xl h-fit sticky top-4">
            ...
            <CardContent className="p-6">
              ...
              <div className="text-center mb-6">
                <div className="w-24 h-24 mx-auto rounded-full border-4 border-hajj-green overflow-hidden bg-gray-100">
                  {profileImageUrl ? (
                    <img
